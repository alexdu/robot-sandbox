...
if sys.platform=="win32":
   ...
   ODE_BASE = r"C:\msys\1.0\home\Alex\src\ode-0.11.1"
   INC_DIRS += [os.path.join(ODE_BASE, "include")]
   LIB_DIRS += [os.path.join(ODE_BASE, "lib", "DebugSingleDLL")]

   LIBS     += ["ode_singled", "user32"]  # user32 because of the MessageBox() call
   #CC_ARGS  += ["/ML"]
...
def generate(name, trimesh_support):
   ...
   cmd = "pyrexc.py -o %s -I. -Isrc src/ode.pyx" % name
   pyrex_out = name
